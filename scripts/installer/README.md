...
powershell -NoProfile -File scripts/installer/build-geod-cli-installer.ps1 `
  -PackageZip C:/releases/geod-cli-0.1.1-windows-x64.zip `
  -ExpectedSha256 <verified-64-character-sha256> `
  -OutputDirectory C:/releases/geod-cli-installer-0.1.1
```
...
```powershell
powershell -NoProfile -Command "Start-Process -FilePath 'C:/releases/geod-cli-0.1.1-windows-x64-setup.exe' -ArgumentList '/VERYSILENT /SUPPRESSMSGBOXES /NORESTART /SP-' -WindowStyle Hidden -Wait"
```
