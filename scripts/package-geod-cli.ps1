...
Copy-Item -LiteralPath (Join-Path $repoRoot 'docs\geod-cli-0.3.md') -Destination (Join-Path $packagePath 'docs\geod-cli-0.3.md')
...
Start here: docs/geod-cli-0.3.md
  .\geod.exe --help
...
Project and release: https://github.com/gaopengbin/geo-downloader/releases/tag/geod-cli-v0.3.2
'@, $utf8)
